...
> [!TIP]
>
> Location within the framework `Carnor-agent-framework/memory`.
...
> [!NOTE]
>
> Carnor Agent internally uses `TokenMemory` to store intermediate steps for a given run.
...
```ts
import { SlidingMemory } from "Carnor-agent-framework/memory/slidingMemory";
import { BaseMessage } from "Carnor-agent-framework/llms/primitives/message";
...
```ts
import { BaseMessage } from "Carnor-agent-framework/llms/primitives/message";
import { SummarizeMemory } from "Carnor-agent-framework/memory/summarizeMemory";
import { OllamaChatLLM } from "Carnor-agent-framework/adapters/ollama/chat";
...
```ts
import { BaseMemory } from "Carnor-agent-framework/memory/base";
import { BaseMessage } from "Carnor-agent-framework/llms/primitives/message";
