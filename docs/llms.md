...
> [!TIP]
>
> Location for concrete implementations within the framework `Carnor-agent-framework/adapters`.
>
> Location for base abstraction within the framework `Carnor-agent-framework/llms`.
...
| ➕ [Request](https://github.com/i-am-Carnor/Carnor-agent-framework/discussions) |                            |                                               |                                          |
...
import { WatsonXLLM } from "Carnor-agent-framework/adapters/watsonx/llm";
...
import { BaseMessage, Role } from "Carnor-agent-framework/llms/primitives/message";
import { OllamaChatLLM } from "Carnor-agent-framework/adapters/ollama/chat";
import { JsonDriver } from "Carnor-agent-framework/llms/drivers/json";
...
To use an inference provider that is not mentioned in our providers list feel free to [create a request](https://github.com/i-am-Carnor/Carnor-agent-framework/discussions).
...
- Base location within the framework: `Carnor-agent-framework/adapters/custom`
